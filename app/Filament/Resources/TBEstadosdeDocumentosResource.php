...
class TBEstadosdeDocumentosResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListTBEstadosdeDocumentos::route('/'),
            'create' => Pages\CreateTBEstadosdeDocumentos::route('/create'),
            'edit' => Pages\EditTBEstadosdeDocumentos::route('/{record}/edit'),
        ];
    }
}
