...
UPDATE documentacionexpedientes set Expediente = LTRIM(RTRIM(Cod_plan)) + '_' +	CAST(referencia AS VARCHAR)+'_' + CAST(subreferencia AS VARCHAR) + '_' + CAST(ao_ejecucion AS VARCHAR);
